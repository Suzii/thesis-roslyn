using System.Linq;
using BugHunter.AbstractionOverImplementation.Analyzers;
using BugHunter.AbstractionOverImplementation.CodeFixes;
...
namespace BugHunter.Test.AbstractionOverImplementationTests
{
    [TestFixture]

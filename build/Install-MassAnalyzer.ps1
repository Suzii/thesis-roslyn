...
#Install-MassAnalyzer -SolutionPath "C:\TFS\CMS\MAIN\CMSSolution" -PackageName "BugHunter.Analyzers" -PackageVersion 1.0.6277.19463 -PackageFileNames @("BugHunter.Analyzers.dll", "BugHunter.Core.dll")

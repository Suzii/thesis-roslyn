...
Install-MassAnalyzer -SolutionPath "C:\TFS\CMS\MAIN\CMSSolution" -PackageName "BugHunter.Analyzers" -PackageVersion 1.0.6267.22492 -PackageFileNames @("BugHunter.Analyzers.dll", "BugHunter.Core.dll")

# inspired by https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/build/build.ps1
param (
	[switch]$Debug,
...
If (-not (Test-Path $nuget)) {
	Write-Host 'Build.ps1 downloading nuget...' -foregroundcolor 'yellow'
	If (-not (Test-Path '..\.nuget')) {
		mkdir '..\.nuget'
	}
